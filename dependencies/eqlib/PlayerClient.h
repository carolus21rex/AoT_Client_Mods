...
/*0x024c*/ uint8_t                  CharClass;
/*0x0250*/ int                      Deity;
/*0x0254*/ int                      PrimaryTintIndex;
/*0x0258*/ unsigned int             RespawnTimer;
/*0x025c*/ uint8_t                  Blind;
/*0x025d*/ char                     DraggingPlayer[0x40];
/*0x02a0*/ int                      IsAttacking;
/*0x02a4*/ int                      WarCry;
/*0x02a8*/ unsigned int             CombatSkillTicks[CONCURRENT_SKILLS];
/*0x02b0*/ float                    MerchantGreed;
/*0x02b4*/ uint8_t                  FindBits;
/*0x02b5*/ uint8_t                  FishingEvent;
/*0x02b6*/ uint8_t                  IsPassenger;
/*0x02b8*/ unsigned int             SpellCooldownETA;
/*0x02bc*/ int                      AFK;
/*0x02c0*/ uint8_t                  FD;
/*0x02c4*/ int                      HideMode;
/*0x02c8*/ bool                     bBuffTimersOnHold;
/*0x02d0*/ CharacterZoneClient*     pCharacter;
/*0x02d8*/ uint8_t                  IntimidateCount;
/*0x02e0*/ int64_t                  HPCurrent;
/*0x02e8*/ unsigned int             LastTick;
/*0x02ec*/ unsigned int             NextSwim;
/*0x02f0*/ int                      ManaMax;
/*0x02f4*/ int                      PetID;
/*0x02f8*/ float                    ViewHeight;
/*0x02fc*/ CPhysicsInfo             LastCollision;
/*0x032c*/ EqItemGuid               realEstateItemGuid;
/*0x033e*/ uint8_t                  Original;
/*0x0340*/ int                      Buyer;
/*0x0344*/ float                    CameraOffset;
/*0x0348*/ int                      Unknown3;
/*0x034c*/ uint8_t                  TitleVisible;
/*0x0350*/ unsigned int             LastPrimaryUseTime;
/*0x0354*/ int                      Unknown1;
/*0x0358*/ unsigned int             LastSecondaryUseTime;
/*0x035c*/ bool                     bSwitchMoved;
/*0x0360*/ unsigned int             LastMealTime;
/*0x0364*/ uint8_t                  StandState;
/*0x0368*/ int                      Birthdate;
/*0x036c*/ unsigned int             LastTimeStoodStill;
/*0x0370*/ uint8_t                  LastAttack;
/*0x0374*/ unsigned int             LastResendAddPlayerPacket;
/*0x0378*/ bool                     Sneak;
/*0x0379*/ bool                     bAlwaysShowAura;
/*0x037c*/ unsigned int             LoginSerial;
/*0x0380*/ unsigned int             Meditating;
/*0x0384*/ int                      AltAttack;
/*0x0388*/ unsigned int             MasterID;
/*0x038c*/ unsigned int             Zone;
/*0x0390*/ unsigned int             StunTimer;
/*0x0394*/ float                    RunSpeed;
/*0x0398*/ int                      ManaCurrent;
/*0x03a0*/ SPAWNINFO*               pViewPlayer;
/*0x03a8*/ bool                     bTempPet;
/*0x03a9*/ bool                     bAttackRelated;
/*0x03ac*/ float                    MissileRangeToTarget;
/*0x03b0*/ int                      DoSpecialMelee;
/*0x03b4*/ char                     GM;
/*0x03b8*/ float                    MyWalkSpeed;
/*0x03bc*/ int                      SomeData[2];
/*0x03c4*/ int                      Trader;
/*0x03c8*/ int                      RealEstateItemId;
/*0x03cc*/ int                      Unknown4;
/*0x03d0*/ unsigned int             CorpseDragCount;
/*0x03d4*/ int                      berserker;
/*0x03d8*/ unsigned int             ACounter;
/*0x03e0*/ unsigned int**           ppUDP;
/*0x03e8*/ LaunchSpellData          CastingData;
/*0x042c*/ int                      EnduranceCurrent;
/*0x0430*/ bool                     Mercenary;
/*0x0434*/ unsigned int             SitStartTime;
/*0x0438*/ bool                     PvPFlag;
/*0x043c*/ int                      CurrIOState;
/*0x0440*/ uint8_t                  InPvPArea;
/*0x0441*/ bool                     bBetaBuffed;
/*0x0442*/ bool                     bOfflineMode;
/*0x0443*/ uint8_t                  HoldingAnimation;
...
/*0x054d*/ bool                     Linkdead;
/*0x054e*/ bool                     bStationary;
/*0x0550*/ unsigned int             LastRangedUsedTime;
/*0x0554*/ char                     Handle[0x20];
/*0x0574*/ unsigned int             LastRefresh;
/*0x0578*/ bool                     bSummoned;
/*0x0579*/ uint8_t                  GMRank;
/*0x057c*/ unsigned int             SpellGemETA[15];
/*0x05b8*/ uint8_t                  Level;
/*0x05bc*/ float                    AnimationSpeedRelated;
/*0x05c0*/ unsigned int             FishingETA;
/*0x05c4*/ int                      Anon;
/*0x05c8*/ int64_t                  GuildID;
/*0x05d0*/ float                    BearingToTarget;
/*0x05d4*/ unsigned int             NextIntimidateTime;
/*0x05d8*/ uint8_t                  Light;
/*0x05e0*/ void*                    pRaceGenderInfo;
/*0x05e8*/ float                    GetMeleeRangeVar1;
/*0x05ec*/ bool                     bAnimationOnPop;
/*0x05f0*/ unsigned int             TimeStamp;
/*0x05f4*/ int                      NpcTintIndex;
/*0x05f8*/ bool                     LFG;
/*0x05fc*/ float                    FallingStartZ;
/*0x0600*/ int                      RealEstateID;
/*0x0608*/ void*                    pTouchingSwitch;
/*0x0610*/ unsigned int             LastTrapDamageTime;
/*0x0614*/ int                      SecondaryTintIndex;
/*0x0618*/ char                     LoginRelated[0x20];
/*0x0638*/ unsigned int             EnduranceMax;
/*0x0640*/ int64_t                  HPMax;
/*0x0648*/ unsigned int             MinuteTimer;
...
// @sizeof(PlayerClient) == 0x1f70 :: 2024-11-18 (live) @ 0x1402eb4ae
